(function () {
  const storageKey = "vstar-content-overrides";
      ...
      fields: [
        ...
        { key: "home.hero.subtitle", label: "首页 Banner 副标题", selector: ".hero-home .hero-content > p:not(.eyebrow)", type: "text", default: "Two bases, verified credentials, and direct vehicle supply." },
        {
          ...
          default: JSON.stringify(
            [
              {
                src: "https://images.pexels.com/photos/3457780/pexels-photo-3457780.jpeg",
                alt: "Black Mercedes-Benz vehicle used as a premium export website visual",
              },
              {
                src: "https://images.pexels.com/photos/3122809/pexels-photo-3122809.jpeg",
                alt: "Mercedes-Benz vehicle detail used as a temporary premium visual",
              },
            ],
            null,
            2
  ...
  function renderHomeHeroSlides(hero, value) {
    const slides = parseImageList(value);
